    ...
    if module_name in modules:
        ...
        if object_name:
            ...
            if not module_object or inspect.ismodule(module_object):
                ...
                Log.info('{}.{} is an object. Sourcing parent: {}'
                         .format(module_name, object_name, module_name))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-v', '--verbose', action='count',
                        help='Be verbse. Use -vv or -vvv to invrease verbosity')
    parser.add_argument('-p', '--prefix',
                        help='Prefix to be used. Defaults to the physical '
                             'path of the source file')
    parser.add_argument('-o', '--output',
                        help='Output file name. Use "-" without quotes to write to console. '
                        'Defaults to the name of the source file.')
    parser.add_argument('-d', '--dir', default='flattened',
                        help='Output directory. Defaults to flattened')
